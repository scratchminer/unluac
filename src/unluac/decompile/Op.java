...
class OpV {
  ...
  public static final int LUA54BETA = 32;
}

public enum Op {
  // Lua 5.1 Opcodes
  MOVE("move", OpV.LUA50 | OpV.LUA51 | OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR),
  LOADK("loadk", OpV.LUA50 | OpV.LUA51 | OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BxK),
  LOADBOOL("loadbool", OpV.LUA50 | OpV.LUA51 | OpV.LUA52 | OpV.LUA53 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B, OperandFormat.C),
  LOADNIL("loadnil", OpV.LUA50 | OpV.LUA51, OperandFormat.AR, OperandFormat.BR),
  GETUPVAL("getupval", OpV.LUA50 | OpV.LUA51 | OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BU),
  ...
  SETUPVAL("setupval", OpV.LUA50 | OpV.LUA51 | OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BU),
  ...
  CALL("call", OpV.LUA50 | OpV.LUA51 | OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B, OperandFormat.C),
  ...
  CLOSE("close", OpV.LUA50 | OpV.LUA51 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR),
  CLOSURE("closure", OpV.LUA50 | OpV.LUA51 | OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BxF),
  ...
  LOADNIL52("loadnil", OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B),
  LOADKX("loadkx", OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR),
  ...
  EXTRAARG("extraarg", OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.Ax),
  // Lua 5.0 Opcodes
  ...
  LOADTRUE("loadtrue", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR),
  GETTABUP54("gettabup", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BU, OperandFormat.CKS),
  GETTABLE54("gettable", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  GETI("geti", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CI),
  GETFIELD("getfield", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CKS),
  SETTABUP54("settabup", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AU, OperandFormat.BK, OperandFormat.CRK54),
  SETTABLE54("settable", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CRK54),
  SETI("seti", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BI, OperandFormat.CRK54),
  SETFIELD("setfield", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BKS, OperandFormat.CRK54),
  NEWTABLE54("newtable", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B, OperandFormat.C, OperandFormat.k),
  SELF54("self", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CRK54),
  ADDI("addi", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CsI),
  ADDK("addk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CK),
  SUBK("subk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CK),
  MULK("mulk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CK),
  MODK("modk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CK),
  POWK("powk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CK),
  DIVK("divk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CK),
  IDIVK("idivk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CK),
  BANDK("bandk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CKI),
  BORK("bork", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CKI),
  BXORK("bxork", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CKI),
  SHRI("shri", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CsI),
  SHLI("shli", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.CsI, OperandFormat.BR),
  ADD54("add", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  SUB54("sub", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  MUL54("mul", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  MOD54("mod", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  POW54("pow", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  DIV54("div", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  IDIV54("idiv", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  BAND54("band", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  BOR54("bor", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  BXOR54("bxor", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  SHL54("shl", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  SHR54("shr", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.CR),
  MMBIN("mmbin", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.C),
  MMBINI("mmbini", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BsI, OperandFormat.C, OperandFormat.k),
  MMBINK("mmbink", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BK, OperandFormat.C, OperandFormat.k),
  CONCAT54("concat", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B),
  TBC("tbc", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR),
  JMP54("jmp", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.sJ),
  EQ54("eq", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.k),
  LT54("lt", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.k),
  LE54("le", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.k),
  EQK("eqk", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BK, OperandFormat.k),
  EQI("eqi", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BsI, OperandFormat.k, OperandFormat.C),
  LTI("lti", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BsI, OperandFormat.k, OperandFormat.C),
  LEI("lei", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BsI, OperandFormat.k, OperandFormat.C),
  GTI("gti", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BsI, OperandFormat.k, OperandFormat.C),
  GEI("gei", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BsI, OperandFormat.k, OperandFormat.C),
  TEST54("test", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.k),
  TESTSET54("testset", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BR, OperandFormat.k),
  TAILCALL54("tailcall", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B, OperandFormat.C, OperandFormat.k),
  RETURN54("return", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B, OperandFormat.C, OperandFormat.k),
  RETURN0("return0", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B, OperandFormat.C, OperandFormat.k),
  RETURN1("return1", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B, OperandFormat.C, OperandFormat.k),
  FORLOOP54("forloop", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BxJn),
  FORPREP54("forprep", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BxJ),
  TFORPREP54("tforprep", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BxJ),
  TFORCALL54("tforcall", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.C),
  TFORLOOP54("tforloop", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.BxJn),
  SETLIST54("setlist", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.B, OperandFormat.C, OperandFormat.k),
  VARARG54("vararg", OpV.LUA54 | OpV.LUA54BETA, OperandFormat.AR, OperandFormat.C),
  VARARGPREP("varargprep", OpV.LUA54, OperandFormat.A),
  // Special
  EXTRABYTE("extrabyte", OpV.LUA50 | OpV.LUA51 | OpV.LUA52 | OpV.LUA53 | OpV.LUA54 | OpV.LUA54BETA, OperandFormat.x),
