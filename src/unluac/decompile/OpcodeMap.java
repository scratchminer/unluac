  ...
  public OpcodeMap(Version.OpcodeMapType type) {
    switch(type) {
      ...
      case LUA54BETA:
        ...
        map[8] = Op.SETUPVAL;
        map[9] = Op.GETTABUP54;
        map[10] = Op.GETTABLE54;
        map[11] = Op.GETI;
        map[12] = Op.GETFIELD;
        map[13] = Op.SETTABUP54;
        map[14] = Op.SETTABLE54;
        map[15] = Op.SETI;
        map[16] = Op.SETFIELD;
        map[17] = Op.NEWTABLE54;
        map[18] = Op.SELF54;
        map[19] = Op.ADDI;
        map[20] = Op.ADDK;
        map[21] = Op.SUBK;
        ...
        map[65] = Op.TESTSET54;
        map[66] = Op.CALL;
        map[67] = Op.TAILCALL54;
        map[68] = Op.RETURN54;
        map[69] = Op.RETURN0;
        map[70] = Op.RETURN1;
        map[71] = Op.FORLOOP54;
        map[72] = Op.FORPREP54;
        map[73] = Op.TFORPREP54;
        map[74] = Op.TFORCALL54;
        map[75] = Op.TFORLOOP54;
        map[76] = Op.SETLIST54;
        map[77] = Op.CLOSURE;
        map[78] = Op.VARARG54;
        map[79] = Op.VARARGPREP;
        map[80] = Op.EXTRAARG;
        map[81] = Op.LOADFALSE;
